...
CREATE TABLE IF NOT EXISTS vendor_applications (
    ...
    status TEXT DEFAULT 'DRAFT' CHECK(status IN ('DRAFT', 'SUBMITTED', 'IN_REVIEW', 'ACCEPTED', 'REJECTED', 'CHANGES_REQUESTED')),
...
CREATE TABLE IF NOT EXISTS purchase_invoices (
    ...
    status TEXT DEFAULT 'Submitted' CHECK(status IN ('Submitted', 'Under Review', 'Accepted', 'Rejected', 'Clarification_Requested', 'Ready for Payment', 'Payment Processing', 'Paid', 'Closed')),
    invoice_file TEXT,
